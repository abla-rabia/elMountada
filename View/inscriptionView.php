...
public function persoInfoSection(){
    ...
    <div class="infoPerso">
            ...
            <div class="line">
                <?php
                $r->famousInput("Prénom","Abla","text");
                $r->famousInput("Nom","Rabia","text");
                ?>
            </div>
            <div class="line">
                <?php
                $r->famousInput("Date de naissance","","date");
...
public function infoCompteSection(){
    ...
    <div class="infoCompte">
            ...
            <div class="line">
                <?php
                $r->famousInput("Mot de passe","***********","password");
...
public function attachements(){
    ...
    <div class="attachement">
            ...
            <div class="line">
                <?php
                $r->famousInput("Photo personnelle","Télécharger la photo","file");
                $r->famousInput("Photo de la carte d’identité","Télécharger la photo de la carte","file");
                ?>
            </div>
            </div>
    <?php
