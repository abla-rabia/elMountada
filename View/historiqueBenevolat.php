            ...
            <body class="to">
                ...
                <div class="content">
                    ...
                    <div class="subContent">
                        <?php $r->historySideBar("Bénévolats"); ?>
                        <div class="users">
                            
                            <table id="all">
                                <tr class="head">
                                    <th onclick="sortTable('nom')">Evennement</th>
                ...
                <script>
                    ...
                    function fetchBenevolats() {

                        $.ajax({
                            url: 'index.php?router=getBenevolatHistory',
                            type: 'GET',
                            dataType: 'json',
                            success: function(data) {
                                
                                $('#all tr:not(.head)').remove();
                                const benevolatsTable = $('#all');
                            ...
                            error: function(data,xhr, status, error) {
                                console.log();
                                console.error('Error fetching benevolats:', error);
                            }
                        });
                    }
